async function http_create(url,data,authValue=null) {
  let o = '';
  try { 
    if(authValue!==null) {
...
async function http_read(url,authValue=null) {
  let o = '';
  try { 
    if(authValue!==null) {
...
async function http_update(url,data,authValue=null) {
  let o = '';
  try { 
    if(authValue!==null) {
...
async function http_delete(url,authValue=null) {
  let o = '';
  try { 
    if(authValue!==null) {
